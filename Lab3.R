...
# 9. Середній індекс по країнах (топ-20) ----------------------------------------
df_country_mean <- df_results %>%
  group_by(Country.name) %>%  # змінюємо на правильну колонку
